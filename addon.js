...
/* Интерфейс */
		...
		Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://Kamikadze22rus.github.io/tmdb.js', 'TMDB Proxy', '@lampa', 'TMDB');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://Kamikadze22rus.github.io/tmdb.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {
						$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						/*var myResult = checkPlugin('https://Kamikadze22rus.github.io/tmdb.js')
						setTimeout(function() {	
                                                ...
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://Kamikadze22rus.github.io/tmdb.js') {
			...
			Lampa.SettingsApi.addParam({
				...
				Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://amikdn.github.io/torrents_styles.js', 'Torrents Styles', '@lampa', 'Torrents Styles');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://amikdn.github.io/torrents_styles.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {
						...
						var myResult = checkPlugin('https://amikdn.github.io/torrents_styles.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://amikdn.github.io/torrents_styles.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
                                                       if (myResult && pluginStatus !== 0) {
                                                          $('div[data-name="Torrents Styles"]').find('.settings-param__status').removeClass('active error').addClass('active');
                                                       } else if (pluginStatus === 0) {
				...
				Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://Kamikadze22rus.github.io/snow.js', 'Snow', '@lampa', 'Snow');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://Kamikadze22rus.github.io/snow.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {
						$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						/*var myResult = checkPlugin('https://Kamikadze22rus.github.io/snow.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://Kamikadze22rus.github.io/snow.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://Kamikadze22rus.github.io/snow.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
		...
		Lampa.SettingsApi.addParam({
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://Kamikadze22rus.github.io/collections.js', 'Коллекции', '@lampa', 'Collections');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://Kamikadze22rus.github.io/collections.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						/*var myResult = checkPlugin('https://Kamikadze22rus.github.io/collections.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://Kamikadze22rus.github.io/collections.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://Kamikadze22rus.github.io/collections.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://Kamikadze22rus.github.io/weather.js', 'Погода', '@scabrum', 'Weather');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://Kamikadze22rus.github.io/weather.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						...
						var myResult = checkPlugin('https://Kamikadze22rus.github.io/weather.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://Kamikadze22rus.github.io/weather.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://Kamikadze22rus.github.io/cuboff.js', 'Cub Off', '@lampa', 'Cub_off');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://Kamikadze22rus.github.io/cuboff.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						...
						var myResult = checkPlugin('https://Kamikadze22rus.github.io/cuboff.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://Kamikadze22rus.github.io/cuboff.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://Kamikadze22rus.github.io/interface.js', 'Стильный Интерфейс', '@lampa', 'Style_interface_fix');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://Kamikadze22rus.github.io/interface.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						/*var myResult = checkPlugin('https://Kamikadze22rus.github.io/interface.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://Kamikadze22rus.github.io/interface.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://Kamikadze22rus.github.io/interface.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
				...
				name: 'Дополнительный источник Кинопоиск (KP)',
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://Kamikadze22rus.github.io/source.js', 'Источник Кинопоиск (KP)', '@lampa', 'New_source');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://Kamikadze22rus.github.io/source.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						/*var myResult = checkPlugin('https://Kamikadze22rus.github.io/source.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://Kamikadze22rus.github.io/source.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://Kamikadze22rus.github.io/source.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://Kamikadze22rus.github.io/start.js', 'Start', '@lampa', 'Start');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://Kamikadze22rus.github.io/start.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						/*var myResult = checkPlugin('https://Kamikadze22rus.github.io/start.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://Kamikadze22rus.github.io/start.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://Kamikadze22rus.github.io/start.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
						...
						onChange: function(value) {
							if (value == '1') {
								itemON('https://Kamikadze22rus.github.io/nots.js', 'Remove TS', '@AndreyURL54', 'ts_del');
							}
							if (value == '2') {
								var pluginToRemoveUrl = "https://Kamikadze22rus.github.io/nots.js";
								deletePlugin(pluginToRemoveUrl);
							}
						},
						onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						...
						var myResult = checkPlugin('https://Kamikadze22rus.github.io/nots.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://Kamikadze22rus.github.io/nots.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://Kamikadze22rus.github.io/rusmovies.js', 'Русские Новинки', '@lampa', 'rus_movie');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://Kamikadze22rus.github.io/rusmovies.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						...
						var myResult = checkPlugin('https://Kamikadze22rus.github.io/rusmovies.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://Kamikadze22rus.github.io/rusmovies.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://Kamikadze22rus.github.io/logo.js', 'Лого Вместо Названия', '@lampa', 'logo_title');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://Kamikadze22rus.github.io/logo.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						...
						var myResult = checkPlugin('https://Kamikadze22rus.github.io/logo.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://Kamikadze22rus.github.io/logo.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://Kamikadze22rus.github.io/cardify.js', 'Cardify', '@lampa', 'cardify');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://Kamikadze22rus.github.io/cardify.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						...
						var myResult = checkPlugin('https://Kamikadze22rus.github.io/cardify.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://Kamikadze22rus.github.io/cardify.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://Kamikadze22rus.github.io/foreign.js', 'Зарубежные Подборки', '@lampa', 'inter_movie');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://Kamikadze22rus.github.io/foreign.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						...
						var myResult = checkPlugin('https://Kamikadze22rus.github.io/foreign.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://Kamikadze22rus.github.io/foreign.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://Kamikadze22rus.github.io/seaseps.js', 'Состояние Сериала', '@lampa', 'eps_and_seas');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://Kamikadze22rus.github.io/seaseps.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						...
						var myResult = checkPlugin('https://Kamikadze22rus.github.io/seaseps.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://Kamikadze22rus.github.io/seaseps.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
...
/* Управление */
		...
		Lampa.SettingsApi.addParam({
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://Kamikadze22rus.github.io/redirect.js', 'Смена Сервера', '@scabrum', 'Redirect');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://Kamikadze22rus.github.io/redirect.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						...
						var myResult = checkPlugin('https://Kamikadze22rus.github.io/redirect.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://Kamikadze22rus.github.io/redirect.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
...
/* Торрент */
		...
		Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://Kamikadze22rus.github.io/jackett.js', 'Переключение Парсеров', '@4m1K', 'Switch_Parser');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://Kamikadze22rus.github.io/jackett.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						/*var myResult = checkPlugin('https://Kamikadze22rus.github.io/jackett.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://Kamikadze22rus.github.io/jackett.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://Kamikadze22rus.github.io/jackett.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
		...
		Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://Kamikadze22rus.github.io/tracks.js', 'Tracks', '@lampa', 'Tracks');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://Kamikadze22rus.github.io/tracks.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						/*var myResult = checkPlugin('https://Kamikadze22rus.github.io/tracks.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://Kamikadze22rus.github.io/tracks.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://Kamikadze22rus.github.io/tracks.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://Kamikadze22rus.github.io/etor.js', 'Настройка Торрентов', '@lampa', 'Setting_torrents');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://Kamikadze22rus.github.io/etor.js";
							deletePlugin(pluginToRemoveUrl);
                                                }
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						/*var myResult = checkPlugin('https://Kamikadze22rus.github.io/etor.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://Kamikadze22rus.github.io/etor.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://Kamikadze22rus.github.io/etor.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://amikdn.github.io/checker.js', 'Поиск Локального TorrServera', '@AndreyURL54', 'Check_server');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://amikdn.github.io/checker.js";
							deletePlugin(pluginToRemoveUrl);
                                                }
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						/*var myResult = checkPlugin('https://amikdn.github.io/checker.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://amikdn.github.io/checker.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://amikdn.github.io/checker.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
						...
						var myResult = checkPlugin('https://amikdn.github.io/freet.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://amikdn.github.io/freet.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }

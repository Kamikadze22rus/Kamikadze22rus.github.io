(function() {
  ...
  if (!window.rch) {
    Lampa.Utils.putScript(["https://lam.akter-black.com/invc-rch.js"], function() {}, false, function() {
      if (!window.rch.startTypeInvoke)
        window.rch.typeInvoke('https://lam.akter-black.com', function() {});
    }, true);
  }
    ...
    this.rch = function(json, noreset) {
      ...
      var load = function load() {
        ...
        hubConnection.start().then(function() {
          window.rch.Registry('https://lam.akter-black.com', hubConnection, function() {
      ...
      if (typeof signalR == 'undefined') {
        Lampa.Utils.putScript(["https://lam.akter-black.com/signalr-6.0.25_es5.js"], function() {}, false, function() {
          load();
        }, true);
      } else load();
    };
